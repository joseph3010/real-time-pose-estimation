...
string img_path = tutorial_path + "Data/mybox.jpeg";  // image to register
string ply_read_path = tutorial_path + "Data/mybox.ply";          // object mesh
string write_path = tutorial_path + "Data/mybox_reg1.yaml";     // output file
...
int main()
{
  ...
  //Ptr<DescriptorExtractor> d =ORB::create();
